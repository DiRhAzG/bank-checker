...
ImageData.fromBase64(function (i) { MaterialsReader.topleft = i }, "");
...
function MaterialsReader() {
	...
	this.find = function (img) {
		...
		var loc = { x: topleft[0].x + 12, y: topleft[0].y + 10, width: -1, height: -1 };
		loc.width = botright[0].x + 7 - loc.x;
		loc.height = botright[0].y + 13 - loc.y;
		...
		me.pos = {
			area: storagearea,
			inner: storageinner,
			columns: Math.floor(storageinner.w / 44),
			legacy: false
		};
	...
	this.read = function (img, forceread) {
        ...
        var searchbuf = img.toData(me.pos.area.x + me.pos.area.w - 8, me.pos.area.y + me.pos.area.h - 14, MaterialsReader.botright.width, MaterialsReader.botright.height);
